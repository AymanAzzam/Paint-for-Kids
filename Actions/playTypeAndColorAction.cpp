...
void playTypeAndColorAction::Execute()
{
	...
	do {
		...
		if (figchoose != NULL)
		{
			if (figchoose->getName() == RandomFig->getName() && (figchoose->getIsFilled() == true) && (figchoose->getFigColor() == Clr))	//make sure that the choosen figure is the required figure
			{
